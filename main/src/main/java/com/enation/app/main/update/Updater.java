...
package com.enation.app.main.update;
...
public class Updater {
    ...
    public static void updataSync(final Context context, final UpdataListener listener){
       new Runnable() {
           @Override
           public void run() {
               update(context,listener);
           }
       }.run();
    }

    public static void update(Context context,UpdataListener listener) {
        ...
        try {
            ...
            UpdateInfo info = new Gson().fromJson(jsonStr,UpdateInfo.class);
    ...
    public static void dexPatchSync(final Context context, final UpdataListener listener){
        new Runnable() {
            @Override
            public void run() {
                 dexPatchUpdate(context,listener);
            }
        }.run();
    }

    private static void dexPatchUpdate(Context context,UpdataListener listener) {
        ...
        try {
            ...
            AtlasUpdater.dexpatchUpdate(context,info, patchFile, new AtlasUpdater.IDexpatchMonitor() {
                ...
                public void merge(boolean success, String bundleName, long version, String errMsg) {
                    Log.e("update","升级成功1!");
                    Log.e("update", "merge: " + success + " " + bundleName + " " + version + " " + errMsg);
                }

                @Override
                public void install(boolean success, String bundleName, long version, String errMsg) {
                    Log.e("update","升级成功2!");
                    Log.e("update", "install: " + success + " " + bundleName + " " + version + " " + errMsg);
                }
            });
            listener.success();
        } catch (Throwable e) {
    ...
    public static UpdateInfo loadUpdateInfo(Context context) {
        ...
        String jsonStr = new String(FileUtils.readFile(updateInfo));
        return new Gson().fromJson(jsonStr, UpdateInfo.class);
    }
